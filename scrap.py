...
def crawler(domain, ofile, mute,cookie):
    try:
...
def main(argv):
    ...
    parser.add_argument('--domain', '-d', required=True,
                        help='domain name of website you want to map."')
    parser.add_argument('--ofile', '-o',
                        help='define output file to save results of stdout. i.e. "test.txt"')
    parser.add_argument('--limit', '-l',
                        help='limit search to the given domain instead of the domain derived from the URL.')
    ...
    if limit is None:
        print()
        crawler(domain, ofile, mute,cookie)
        print()
    else:
        print()
